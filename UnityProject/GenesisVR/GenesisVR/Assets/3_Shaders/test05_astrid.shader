...
Shader "[Test]/test05_astrid"
{
	Properties
	{
		...
		[Toggle]_Transparentbiasmustbe1("Transparent? (bias must be <1)", Float) = 0
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Albedo = ( _Color + ( _Color * fresnelNode1 ) ).rgb;
			float3 temp_cast_1 = (lerp(0.0,fresnelNode1,_Emission)).xxx;
...
Node;AmplifyShaderEditor.SimpleAddOpNode;77;-568.1421,-385.0845;Float;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SaturateNode;70;-435.5688,241.7658;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ToggleSwitchNode;5;-327.345,27.37169;Float;False;Property;_Emission;Emission?;8;0;Create;True;0;0;False;0;0;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
